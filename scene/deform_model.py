...
class DeformModel:
    def __init__(self, args):
        self.deform = DeformNetwork(
            args.x_multires, 
            args.t_multires, args.timenet, args.time_out, 
            args.num_basis, args.num_coeff_set_per_basis, args.channel_mb, args.depth_mb, 
            args.channel_cn, args.depth_cn, args.softmax, args.num_attribute, 
            ).cuda()
